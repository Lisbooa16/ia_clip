...
def compute_vertical_crop(face_box, frame_w, frame_h):
    ...
    last_y = getattr(compute_vertical_crop, "_last_y", None)
    if last_x is None:
        smooth_x = desired_x
    else:
